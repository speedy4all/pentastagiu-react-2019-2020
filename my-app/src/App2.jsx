...
import './App.css';
  ...
  class App extends React.Component {
    ...
    render() {
      return (
        <>
        <Header {...this.state.titleList} toggleList={ this.changeDisplayList } list={ this.state.listToDisplay } />
        <div className='list-container'>
          <div className={ this.state.listToDisplay === 'Cars' ? 'table-container' : 'hide-item' }>
          ...
          <div className={ this.state.listToDisplay === 'Cart' ? 'table-container' : 'hide-item' }>
            { this.state.carListLoading?<p>Loading...</p>:(
              <table>
                <thead> 
                  <tr key = 'tableHead'>
